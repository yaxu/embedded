...
main = drawText "slowspread (density) [3,4] $ every 3 (rev) $ p \"grey lightgrey darkgrey black lightgrey\"" (slowspread (density) [3,4] $ every 3 (rev) $ p "grey lightgrey darkgrey black lightgrey")
